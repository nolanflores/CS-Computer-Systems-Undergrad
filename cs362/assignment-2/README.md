...
**→ Preferred deadline: 11:59pm on Monday, 4/27/2026** <br/>
**→ Extension deadline: 11:59pm on Wednesday, 4/29/2026 (no submissions allowed after this)** <br/>
**→ Grading demo due: 11:59pm on Monday 5/11/2026**

In this assignment you will use the [Jest testing framework](https://jestjs.io/) write unit tests for some functions used to verify user input during the user signup process.  You will also explore using the test-driven development process to implement a small software feature.  The parts of the assignment are outlined below.
...
Your last task for this assignment will involve using test-driven development (TDD) to implement a new software feature.  Specifically, you'll use TDD to implement a Roman numeral converter that takes standard Arabic numbers (e.g. 3, 8, 64, 207, 2026, etc.) as input and converts those numbers to Roman numerals.  This conversion will be based on the following table of Arabic number and Roman numeral equivalents.
...
We'll be using GitHub Classroom for this assignment, and you will submit your assignment via GitHub.  Make sure your completed files are committed and pushed by the assignment's deadline to the main branch of the GitHub repo that was created for you by GitHub Classroom.  A good way to check whether your files are safely submitted is to look at the main branch your assignment repo on the github.com website (i.e. https://github.com/osu-cs362-sp26/assignment-2-YourGitHubUsername/).  If your changes show up there, you can consider your files submitted.
...
* Unit tests for `verifyEmail()`: 13 points
  * 2 points: Unit tests are correctly set up using Jest and execute to completion.
  * 3 points: Unit tests provide broad coverage of *valid* inputs to `verifyEmail()`.
  * 3 points: Unit tests provide broad coverage of boundary cases and *invalid* inputs to `verifyEmail()`.
  * 5 points: Unit tests follow testing best practices listed above.
...
* Unit tests for `verifyPassword()`: 17 points
  * 2 points: Unit tests are correctly set up using Jest and execute to completion.
  * 5 points: Unit tests provide broad coverage of *valid* inputs to `verifyPassword()`.
  * 5 points: Unit tests provide broad coverage of boundary cases and *invalid* inputs to `verifyPassword()`.
  * 5 points: Unit tests follow testing best practices listed above.
    * Tests should have descriptive names, be clear and concise, be behavior-driven, follow the AAA pattern, and avoid anti-patterns.
    * Tests must pass!

* Uses TDD to implement a Roman numeral converter: 20 points
  * 7 points: Submission correctly follows TDD.
  ...
  * 5 points: Unit tests follow testing best practices listed above.
    * Tests should have descriptive names, be clear and concise, be behavior-driven, follow the AAA pattern, and avoid anti-patterns.
    * Tests must pass!
  * 5 points: Submission contains a correctly implemented "old" Roman numeral converter.
    * See Section 3 above for details.
  * 3 points: Unit tests provide broad coverage of boundary cases and invalid inputs.
