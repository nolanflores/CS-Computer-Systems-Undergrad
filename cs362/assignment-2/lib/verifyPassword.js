 ...
 *
 *     An example return value for a password that doesn't contain a symbol
 *     or an uppercase character looks like this:
 *
 *       {
 *         pass: false,
 *         length: true,
...
/*
 * Below are utility functions that each performs an individual verification
 * check on a password.
 */
