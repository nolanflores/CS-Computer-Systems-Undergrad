...
function runCalculator() {
    ...
    async function updateDisplay() {
        ...
        try {
            ...
            /*
             * Calculate and apply scale to make sure text stays in bounds.
             */
            const availWidth = textDisplay.parentNode.offsetWidth
            const actualWidth = textDisplay.offsetWidth
            const scale = Math.min(1, availWidth / actualWidth)
            textDisplay.style.transform = `scale(${scale},${scale})`
        } catch (e) {
            /*
